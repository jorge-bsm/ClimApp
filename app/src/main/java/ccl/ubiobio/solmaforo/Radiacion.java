...
public class Radiacion extends AppCompatActivity {
    ...
    public void radiacionActual(final String fecha){
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                int radActual = leer.getInt("radiacionActual",0);

                if(radActual!=0){
                    gaugeRadiacion.speedTo(radActual);
                }else {
                    Toast.makeText(Radiacion.this,"Ocurrio un error en la obtencion de datos actuales",Toast.LENGTH_SHORT).show();
    ...
    public void radiacionPromedio(final String fecha){
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("LOG_WS",error.toString());
                int radProm= leer.getInt("radiacionPromedio",0);
                if(radProm!=0){
                    gaugeRadiacionProm.speedTo(radProm);
                }else{
                    Toast.makeText(Radiacion.this,"Ocurrio un error en la obtencion de datos del promedio",Toast.LENGTH_SHORT).show();
