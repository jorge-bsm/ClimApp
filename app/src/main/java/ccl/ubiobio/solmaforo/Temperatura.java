...
// Ocupar el primer gauge con colores amarillo, naranjo y rojo
    ...
    public void temperaturaActual(final String fecha){
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                int tempActual= leer.getInt("temperaturaActual",0);

                if(tempActual!=0){
                    gaugeTemperatura.speedTo(tempActual);
                }else{
                    //gaugeTemperatura.speedTo(leer.getInt("temperaturaActual",0));
                    Toast.makeText(Temperatura.this,"Ocurrio un error en la obtencion de datos actuales",Toast.LENGTH_SHORT).show();
    ...
    public void temperaturaPromedio(final String fecha){
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("LOG_WS",error.toString());
                int tempProm= leer.getInt("temperaturaPromedio",0);
                if(tempProm!=0){
                    gaugeTemperaturaProm.speedTo(tempProm);
                }else{
                    Toast.makeText(Temperatura.this,"Ocurrio un error en la obtencion de datos del promedio",Toast.LENGTH_SHORT).show();
                }
