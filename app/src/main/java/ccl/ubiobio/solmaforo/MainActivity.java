...
protected SharedPreferences leerMain;
protected SharedPreferences.Editor guardarMain;
protected int humedadActualMain, temperaturaActualMain, radiacionActualMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leerMain = getSharedPreferences("ccl.ubiobio.solmaforo",MODE_PRIVATE);
        guardarMain = leerMain.edit();
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    guardarMain.putInt("temperatura",temperatura);
                    guardarMain.commit();
                    maintemp.setText(temperatura+"°C");
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("LOG_WS",error.toString());
                temperaturaActualMain=leerMain.getInt("temperatura",0);
                maintemp.setText(temperaturaActualMain+"°C");
            }
        });
        requestQueue.add(request);
    }
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    guardarMain.putInt("radiacion",radiacion);
                    guardarMain.commit();
                    mainrad.setText(radiacion+"");
                    //Toast.makeText(Temperatura.this,"valor. "+valorActual+" y la hora es: "+horaActual,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("LOG_WS",error.toString());
                radiacionActualMain= leerMain.getInt("radiacion",0);
                mainrad.setText(radiacionActualMain+"");
            }
        });
        requestQueue.add(request);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, WS_URL, null , new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    guardarMain.putInt("humedad",humedad);
                    guardarMain.commit();
                    mainhum.setText(humedad+"%");
                    //Toast.makeText(Temperatura.this,"valor. "+valorActual+" y la hora es: "+horaActual,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("LOG_WS",error.toString());
                humedadActualMain = leerMain.getInt("humedad",1);
                mainhum.setText(humedadActualMain +"%");
